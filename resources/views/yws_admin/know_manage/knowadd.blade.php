...
@section('content')
    ...
    <section class="Hui-article-box">
        ...
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页
            ...
            知识堂管理
            <span class="c-gray en">&gt;</span>
            知识堂添加 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a> </nav>
        <div class="Hui-article">
        <article  class="cl pd-20" style="width: 50%;margin: 0 auto;margin-top: 20px;">

            <form   action="{{ url('admin/service/goodsadd') }}" enctype="multipart/form-data" onsubmit="return false" method="post" class="form form-horizontal" id="form-know-add" >
                {{ csrf_field() }}
                <div class="row cl">
                    <span class="c-red">*</span>知识堂标题：
                        <input type="text" class="input-text"  placeholder="名称" id="knowname" name="knowname">
