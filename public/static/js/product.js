layui.use(["laypage","form","layer", "datatable", "datatableButton", "datatableFlash", "datatableHtml5", "datatablePrint", "datatableColVis", "datatableSelect"], function () {
    ...
    t.fn.dataTableExt.oSort["chinese-asc"] = function (t, e) {
        ...
        var e = t("#userTable").DataTable({
            ...
            info: !0,
            order: [1, "desc"],
            aoColumnDefs: [{orderable: !1, aTargets: [0, 13]}],
            deferRender: !0,
            sAjaxSource: "../admin/product/ajax",//"../../../json/user.json
            select: {style: "multi"},
            fnServerData:function ( sSource, aoData, fnCallback ) {
                ...
                t.ajax({
                    ...
                    success:function (result) {
                        console.log(result);
                        fnCallback(result);//把返回的数据传给这个方法就可以了,datatable会自动绑定数据
                        laypage({
                            cont: 'demo1'
                            ...
                            ,jump:function(obj, first){
                                if(!first){
                                    window.location.href='/admin/product?page='+obj.curr;
            ...
            columns: [{
            ...
            }, {data: "pid", sTitle: "ID", sDefaultContent: ""},
                {
                    ...
                    data: function (t) {
                        return '<u  data-productId="'+t.pid+'">' + t.follow_count + "</u>";
                    }, className: "td-handle", sTitle: "关注人数", sDefaultContent: "0"
                },
                {
                data: function (t) {
                ...
                data: function (t) {
                    return "&nbsp;" + t.saleprice!=null?t.saleprice:'' + "&nbsp;"
                }, sTitle: "最终成交价格(元)", sDefaultContent: ""
            }, {data: "btime", sTitle: "上架时间", sDefaultContent: ""},{
                    data: function (t) {
                        switch (t.pstatus){
                            case 0:
                                return '<span class="label label-stop radius">审核中...</span>';
                            case 1:
                                return '<span class="label label-start radius">即将开始</span>';
                            case 2:
                                return '<span class="label label-running radius">正在进行</span>';
                            case 3:
                                return '<span class="label badge-danger radius">已经结束</span>';
                            default:
                                return t.pstatus;
                        }
                    ...
                    data: function (t) {
                        switch (t.recommend){
                            case 0:
                                return '<span class="label badge-danger radius">否</span>';
                            case 1:
                                return '<span class="label label-running radius">是</span>';
                            default:
                                return t.pstatus;
                        }
                    }, sTitle: "首页推荐", sDefaultContent: ""
                },{
                data: function (t) {
                    var tmp = '';
                    return tmp+'<span title="编辑" data-productId='+t.pid+' class="handle-btn handle-btn-edit"><i class="linyer icon-edit"></i></span>';//<span title="删除" class="handle-btn handle-btn-delect"><i class="linyer icon-delect"></i></span>
        ...
        t(this);
        var id = t(this).attr('data-productId');
        layer_show("编辑", "./product/"+id+'/edit', "", "800", "600")
