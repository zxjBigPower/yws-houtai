layui.use(["laypage","form","layer", "datatable", "datatableButton", "datatableFlash", "datatableHtml5", "datatablePrint", "datatableColVis", "datatableSelect"], function () {
    ...
    t.fn.dataTableExt.oSort["chinese-asc"] = function (t, e) {
        ...
        var e = t("#bannersTable").DataTable({
            ...
            deferRender: !0,
            sAjaxSource: "../admin/bannersList/ajax",//"../../../json/user.json
            select: {style: "multi"},
            fnServerData:function ( sSource, aoData, fnCallback ) {
                ...
                t.ajax({
                    ...
                    data: {
                        ...
                        search:GetQueryString('search'),city:GetQueryString('city'),
                    ...
                    success:function (result) {
                        ...
                        laypage({
                            ...
                            ,jump:function(obj, first){
                                if(!first){
                                    window.location.href='/admin/bannersList?page='+obj.curr;
            ...
            columns: [{
                ...
                {data: "city", sTitle: "城市", sType: "chinese", sDefaultContent: ""},
                {
                    data: function (t) {
        ...
        t(this);
        var id = t(this).parent().parent().find('td:first-child').find('input:first-child').attr('data-id');
        layer_show("修改密码", "./bannersList/getUpdatePassword/"+id, "", "800", "600")
