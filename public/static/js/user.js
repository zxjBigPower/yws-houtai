layui.use(["laypage","form","layer", "datatable", "datatableButton", "datatableFlash", "datatableHtml5", "datatablePrint", "datatableColVis", "datatableSelect"], function () {
    ...
    t.fn.dataTableExt.oSort["chinese-asc"] = function (t, e) {
        ...
        var e = t("#userTable").DataTable({
            ...
            deferRender: !0,
            sAjaxSource: "../admin/userList/ajax",//"../../../json/user.json
            select: {style: "multi"},
                    ...
                    success:function (result) {
                        ...
                        laypage({
                            ...
                            ,jump:function(obj, first){
                                if(!first){
                                    window.location.href='/admin/userList?page='+obj.curr;
            ...
            },{data: "nickname", sTitle: "昵称", sType: "chinese", sDefaultContent: ""},
                {data: "level", sTitle: "会员等级", sDefaultContent: ""},
                {data: "balance", sTitle: "余额", sDefaultContent: "0"}, {
                data: function (t) {
                    return "&nbsp;" + t.mobile!=null?t.mobile:'' + "&nbsp;"
                }, sTitle: "手机号码", sDefaultContent: ""
            }, {data: "email", sTitle: "邮箱", sDefaultContent: ""},
                {
                    data: function (t) {
                        switch (t.status){
                            case 1:
                    ...
                    }, className: "td-handle", sTitle: "实名", sDefaultContent: ""
                },
                {
                data: function (t) {
                    var tmp = '';
                    return tmp+'<span title="编辑" class="handle-btn handle-btn-edit"><i class="linyer icon-edit"></i></span><span title="修改密码" class="handle-btn handle-btn-updatepwd"><i class="linyer icon-xgpwd2"></i></span>';//<span title="删除" class="handle-btn handle-btn-delect"><i class="linyer icon-delect"></i></span>
        ...
        t(this);
        var id = t(this).parent().parent().find('td:first-child').find('input:first-child').attr('data-id');
        layer_show("编辑", "./userList/"+id+'/edit', "", "800", "600")
    }), t(".table-sort").on("click", ".handle-btn-updatepwd", function () {
        t(this);
        var id = t(this).parent().parent().find('td:first-child').find('input:first-child').attr('data-id');
        layer_show("修改密码", "./userList/getUpdatePassword/"+id, "", "800", "600")
