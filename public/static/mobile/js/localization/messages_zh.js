(function( factory ) {
    ...
    $.validator.addMethod("IsChineseCharacter",function(value,element,params){
        return this.optional(element)||(!validator.IsChineseCharacter(value));
    },"不能包含中文");
    $.validator.addMethod("checkIdCard",function(value,element,params){
        return this.optional(element)||(validator.IsIDCard(value));
    },"请输入正确的身份证号码");
    $.validator.addMethod("checkEq",function(value,element,params){
